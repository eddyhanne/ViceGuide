...
if ($method === 'POST') {
    ...
    $inner = '<div class="m-h" style="' . $HEAD . ';font-size:24px;font-weight:700;color:#221041;line-height:1.2;margin:0 0 12px">Fast geschafft!</div>'
           ...
           . '<td width="50" style="vertical-align:middle"><div style="width:40px;height:40px;border-radius:9px;background:#E1306C;color:#ffffff;text-align:center;line-height:40px;font-size:20px">&#128247;</div></td>'
