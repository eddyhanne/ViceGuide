...
└─ api/
   ...
   ├─ comments.php         GET/POST/PATCH/DELETE für Kommentare, inkl. Admin-Benachrichtigung (Mail bei fremdem Kommentar) und GET ?recent=1 fürs Popup
