...
2. **Navigations- und Taxonomie-Modell (Nordstern festgelegt, Juli 2026, Umsetzung offen).** Entschieden mit dem Betreiber, gilt als Zielbild für die gesamte Navigation:
   ...
   - **Umsetzung als eigenes Paket näher an Phase 2:** `renderSidebar` verschlanken, Datenbank- und Guides-Hub mit eigenen URLs bauen, Filter-Tabs statt Dropdown, Startseite auf die zwei Welten umstellen. Später Unterkategorie-URLs (`/fahrzeuge/sportwagen/`) für Long-Tail-SEO. Die konkreten Unterkategorien erst mit echten Release-Daten füllen, jetzt nichts erraten.
