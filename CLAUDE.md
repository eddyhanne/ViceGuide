...
**Wartung: Bildquellen vereinheitlichen (`bulkCredit()`).** Setzt bei allen Artikeln und DB-Einträgen mit Bild die Quelle auf "Rockstar" (früher teils "Rockstar Games" oder leer) und veröffentlicht direkt. Der Default-Credit im Bild-Editor ist ebenfalls "Rockstar".
